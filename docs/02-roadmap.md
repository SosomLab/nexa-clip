...
| **M2** | **기기 연결** | 내 PC들이 하나처럼 | ★ **Windows에서 CopyQ를 지운다** · *"저쪽에 있는데"* 가 사라진다 |
...
| **보안** | ★ **민감 표식 존중** · **제외 앱** · **디스크 봉인** · 무해화 · 네트워크 0 | **전송 E2E** · 기기 폐기 | 패턴 제외 · 자동 만료 · **앱 잠금** | 생체 잠금 |
| **동기화** | ✕ **없음**(로컬 전용) | ★ **UserId 기기 자동 연동** · **LAN 직결** · **릴레이 경유** · **자동 전파**(에코 차단·되돌리기) | 신뢰 기기와 **공유**(수동·보드) | **모바일 수신** · 오프라인 큐 |
