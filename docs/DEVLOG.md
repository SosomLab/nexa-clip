...
## 2026-09-13 (6차 · Linux VM) — 갈라진 main 병합 2회(mac 1~3차 + 내 수정 브랜치 · 코드 자동 병합 · 문서 7건 충돌 해소 · 내 기록 4·5차로 재번호) · ★ 병합이 드러낸 모순 2건 정리 — `publish_cached`에 같은 결함 2호(`cached_reps` 순수 함수로 통일) · **21 §6 S18·S22 기대 개정**(사전 캐시 완료 게시가 09-13에 되살아났는데 점검표는 옛 동작) · 543 테스트 · 3타깃+fmt ✓ → [journal](journal/2026-09-13.md)
