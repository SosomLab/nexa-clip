...
- 16차(Windows) — ★ **리치 2단**(Outlook `n`=■ 심볼 치환 · `<li>` 불릿 · `margin-left` 들여쓰기 · 배율 · ★ 인라인 `data:` 이미지(미리보기·이미지로 복사) — CopyQ "이미지 렌더" 대신 런 파서 확장 · 배포 드라이런 녹색) · ★ **활성 대상 따라가기**(더블클릭 승격 후 선택·스크롤이 새 자리로, 미리보기 유지)
