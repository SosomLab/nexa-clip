...
| 🚧 | 자동 전파(에코 차단 · 전순서 · 덮어쓰기 정책) — 평문·PNG 1단 ✅(09-04) · ★ **파일 경로 전파 ✅(09-12)** · ★ **파일 내용 공유 🔶(09-12 — DR-30/43 · 붙여넣을 때 받기 · 캐시 · 저속 사전 캐시 · 이어 받기 · 패널/트레이 · 525 테스트 · T-31c 두 기기 실기 ⏳)** · 리치·덮어쓰기 정책·되돌리기 ☐ |
| ☐ | 신뢰 기기와 **공유**(수동·보드 단위) |
